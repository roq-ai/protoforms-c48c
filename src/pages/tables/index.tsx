...
function TableListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<TableInterface[]>(
    ...
    () =>
      getTables({
        relations: ['client', 'data_entry.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('data_entry', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>data_entry</Th>}
                  <Th>Actions</Th>
                </Tr>
              </Thead>
              <Tbody>
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    {hasAccess('data_entry', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>{record?._count?.data_entry}</Td>
                    )}
                    <Td>
